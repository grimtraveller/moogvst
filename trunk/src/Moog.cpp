...
Moog::Moog() :
	oscil1_freq(0), oscil1_amp(1.0), oscil2_freq(0), oscil2_amp(1.0),
			noise_amp(1.0), adder(3), mult_aux(3), master_amp(1.0) {
...
void Moog::updateOscil1(){
	oscil1_freq.setNumber(input_freq*((float)oscil1_range/8.0)*pow(2.0,oscil1FreqOffset/12) );
}

void Moog::updateOscil2(){
	oscil2_freq.setNumber(input_freq*((float)oscil2_range/8.0)*pow(2.0,oscil2FreqOffset/12) );
}
