...
\parbox{1.5in}{
    \centering
    \includegraphics[scale=0.3]{q0.png}
    }%
\qquad	  
\parbox{1.5in}{
      \centering
...
\begin{figure}
\centering
\includegraphics[scale=0.1]{q356.png}\caption{Filtro com q=3.56}\label{fig:q=3.56}
\end{figure}

\begin{figure}
\centering
\includegraphics[scale=0.1]{q357.png}\caption{Filtro com q=3.57}\label{fig:q=3.57}
\end{figure}
